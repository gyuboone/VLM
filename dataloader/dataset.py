...
from utils import load_from_yaml_file, read_json
...
def get_img_id_to_img_path(annotations):
    pattern = r"^(0000001|0000002|0000003|0000004|0000005|0000006)"
    img_id_to_img_path = {}
...
class CLIP_COCO_dataset(Dataset):
    ...
    def __init__(self, train_annotation_file, train_img_dir, text_tokenizer, context_length=77, input_resolution=224):
